...
const Navbar = ({
  ...
  return (
    <nav
      className={`nav-bar ${isResponsive ? "responsive" : ""} ${
        isOpen ? "isopen" : ""
      }`}
      id="Navbar"
    >
      <ul className="nav-list">
        <li className="logo" onClick={toggleNavbar}>
          <a href="#" className="logo-link">
            ...
            <div className="icon">
              <svg
                className={`close-nav ${isOpen ? "" : "nav-hidden"}`}
                height="26"
                width="22"
                viewBox="0 0 384 512"
              >
              ...
              <svg
                className={`open-nav ${isOpen ? "nav-hidden" : ""}`}
                height="26"
                width="24"
                viewBox="0 0 448 512"
              >
        ...
        <div className="nav-heading">
          <svg height="22" width="20" viewBox="0 0 448 512">
        ...
        {Object.keys(clientsByCounty).map((county) => (
          <li
            key={county}
            className={`nav-list-item ${activeItem === county ? "active" : ""}`}
          >
            <a
              href="#"
              className="nav-link"
              onClick={() => handleNavItemClick(county)}
            >
